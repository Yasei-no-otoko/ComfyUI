...
set "ROCM_CORE=C:\Users\HarutoWatanabe\AppData\Local\Programs\Python\Python313\Lib\site-packages\_rocm_sdk_core"
set "ROCM_DEVEL=C:\Users\HarutoWatanabe\AppData\Local\Programs\Python\Python313\Lib\site-packages\_rocm_sdk_devel"
set "ROCM_LIBS=C:\Users\HarutoWatanabe\AppData\Local\Programs\Python\Python313\Lib\site-packages\_rocm_sdk_libraries_gfx1151"
...
set "LIB=%ROCM_CORE%\lib;%ROCM_DEVEL%\lib;%LIB%"
...
"%PYTHON_EXE%" -u main.py --listen 0.0.0.0 --use-sage-attention --disable-xformers --gpu-only
