...
rem Keep xFormers disabled so ComfyUI imports the standalone ROCm/flash-attention package from PR #184.
"%PYTHON_EXE%" -u main.py --enable-manager --listen 0.0.0.0 --gpu-only --use-flash-attention --disable-xformers %*
